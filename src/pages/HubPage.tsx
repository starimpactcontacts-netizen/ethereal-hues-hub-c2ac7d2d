      ...
      <div className="relative z-10">
        ...
        <div className="relative px-4 pt-5 pb-0">
          ...
          <div className="relative mt-4 mb-3">
            ...
            <div className="absolute top-1/2 -translate-y-1/2 z-0 pointer-events-none" style={{ marginTop: '-8px', left: '-50vw', right: '-50vw', marginLeft: '-50%', marginRight: '-50%', width: '100vw', position: 'absolute', left: '50%', transform: 'translateX(-50%) translateY(-50%)' }}>
