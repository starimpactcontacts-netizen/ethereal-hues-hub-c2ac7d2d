            ...
            <AnimatePresence mode="wait" initial={false}>
              {!playExpanded ? (
                ...
                >
                  ...
                  <button
                    onClick={() => { setPlayExpanded(false); navigate(profile ? '/solo/create' : '/start'); }}
                    className="w-full py-2.5 active:scale-[0.99] transition flex flex-col items-center justify-center"
                  ...
                  >
                    ...
                    <span className="text-[9px] font-black text-muted-foreground uppercase tracking-[0.2em] mt-0.5" style={{ fontFamily: 'Teko, sans-serif' }}>Drop A Solo Edit</span>
                  </button>
