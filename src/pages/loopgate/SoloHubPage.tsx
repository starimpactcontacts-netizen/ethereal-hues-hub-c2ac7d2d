    ...
    <div className="min-h-screen bg-black text-white pb-24">
      ...
      <main className="max-w-xl mx-auto px-4 py-5">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 bg-[#0e0e0e] border border-white/5 text-white/90 h-12 rounded-xl text-sm mb-5 active:opacity-70 transition-opacity"
        >
