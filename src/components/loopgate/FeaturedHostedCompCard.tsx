...
import { 
  Globe, Users, Clock, Trophy, ChevronRight 
} from "lucide-react";
...
export default function FeaturedHostedCompCard({ comp, onClick }: FeaturedHostedCompCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="h-16 bg-gradient-to-br from-cyan-500/20 via-sky-500/10 to-transparent relative">
        {comp.poster_url && (
      ...
      <div className="p-3 -mt-4 relative">
        ...
        <div className="flex items-center gap-2 text-[9px] text-muted-foreground">
          <div className="flex items-center gap-0.5">
            ...
            <span>{comp.submission_count || 0}</span>
          </div>
