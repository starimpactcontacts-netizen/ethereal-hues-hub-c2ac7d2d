  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-end sm:items-center justify-center">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative w-full sm:max-w-md h-[80vh] sm:h-[70vh] bg-gradient-to-b from-[#1a0b2e] to-[#0a0418] border-t-2 sm:border-2 border-violet-500/30 rounded-t-3xl sm:rounded-3xl shadow-[0_-10px_40px_rgba(0,0,0,0.6)] flex flex-col overflow-hidden">
        {/* Header */}
        ...
        {/* Composer */}
        <div className="p-3 border-t border-white/10 bg-black/40 pb-[calc(env(safe-area-inset-bottom)+12px)]">
          {user ? (
