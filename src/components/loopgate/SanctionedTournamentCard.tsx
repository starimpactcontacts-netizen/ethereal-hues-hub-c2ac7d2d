...
export default function SanctionedTournamentCard({ tournament, onClick }: SanctionedTournamentCardProps) {
  ...
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.98 }}
      onClick={onClick}
      className="w-[200px] shrink-0 bg-surface-1 border border-gold/30 hover:border-gold/60 transition-all cursor-pointer group overflow-hidden"
    >
      {/* Poster / Header */}
