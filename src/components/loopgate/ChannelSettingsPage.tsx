        ...
        <div className="px-3 py-3 space-y-3 max-w-lg mx-auto">
          ...
          <div>
            ...
            {!activeCommand ? (
              <div className="space-y-0.5">
                {commands.map((cmd) => (
                  <button
                    ...
                    className="w-full flex items-center gap-2.5 px-2.5 py-2.5 rounded-lg hover:bg-muted/30 transition-colors text-left active:scale-[0.98] touch-manipulation"
                  >
              ...
              <div className="space-y-2.5 bg-muted/10 border border-border/30 rounded-lg p-3">
                {/* Embed */}
                {activeCommand === "embed" && (
                  <>
