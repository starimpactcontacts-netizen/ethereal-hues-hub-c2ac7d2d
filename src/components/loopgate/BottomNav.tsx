...
export default function BottomNav() {
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)', backgroundColor: '#000000' }}>
        {/* Infinite black fill below nav to cover any iOS safe area or overscroll */}
        <div className="absolute left-0 right-0" style={{ top: 0, bottom: '-200px', backgroundColor: '#000000' }} />
