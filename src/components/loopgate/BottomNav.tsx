...
export default function BottomNav() {
  ...
  return (
    <>
      ...
      <nav className="fixed left-0 right-0 z-50" style={{ bottom: 'calc(-1 * env(safe-area-inset-bottom, 0px) - 20px)', paddingBottom: 'calc(env(safe-area-inset-bottom) + 20px)', backgroundColor: '#000000' }}>
        <div className="absolute inset-0" style={{ bottom: '-300px', backgroundColor: '#000000' }} />
