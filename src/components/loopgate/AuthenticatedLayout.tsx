...
export default function AuthenticatedLayout() {
  ...
  const hideNavPaths = ['/admin', '/onboarding', '/editorium', '/missions', '/shop', '/competition/', '/fight/', '/collabs', '/collab/', '/duo-battle/', '/event/', '/units/', '/solo/create'];
  const hideHeaderPaths = ['/messages', '/editorium', '/judge-panel', '/judges', '/missions', '/shop', '/competition/', '/fight/', '/collabs', '/collab/', '/duo-battle/', '/event/', '/units/', '/solo/create'];
