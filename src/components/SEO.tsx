...
const defaultMeta = {
  ...
  image: 'https://dpoyjziejujqjvhubxcs.supabase.co/storage/v1/object/public/loop-media/branding/loopgate-og.png',
...
export default function SEO({ 
  ...
  const structuredData = {
    ...
    '@graph': [
      {
        '@type': 'Organization',
        '@id': 'https://loopgate.gg/#organization',
        name: 'Loopgate',
        alternateName: ['LOOPGATE', 'Loopgate.io', 'Loop Gate'],
        url: 'https://loopgate.gg',
        logo: {
          '@type': 'ImageObject',
          url: 'https://dpoyjziejujqjvhubxcs.supabase.co/storage/v1/object/public/loop-media/branding/loopgate-og-icon.png',
          width: 512,
          height: 512,
        },
        sameAs: [
      ...
      {
        '@type': 'WebSite',
        '@id': 'https://loopgate.gg/#website',
        url: 'https://loopgate.gg',
        name: 'Loopgate',
        alternateName: 'Loopgate — #1 Edit Competition Platform',
        description: defaultMeta.description,
        publisher: { '@id': 'https://loopgate.gg/#organization' },
        potentialAction: {
          '@type': 'SearchAction',
          target: {
            '@type': 'EntryPoint',
            urlTemplate: 'https://loopgate.gg/index?q={search_term_string}',
          },
      ...
      },
      {
        ...
        isPartOf: { '@id': 'https://loopgate.gg/#website' },
        about: { '@id': 'https://loopgate.gg/#organization' },
        inLanguage: 'en-US',
      },
      {
        '@type': 'WebApplication',
        '@id': 'https://loopgate.gg/#app',
        name: 'Loopgate',
        url: 'https://loopgate.gg',
      ...
      },
      {
        ...
        url: [
          'https://loopgate.gg/arena',
          'https://loopgate.gg/rankings',
          'https://loopgate.gg/judges',
          'https://loopgate.gg/about',
          'https://loopgate.gg/download',
          'https://loopgate.gg/enterprise',
          'https://loopgate.gg/faq',
          'https://loopgate.gg/rules',
        ],
      },
      // FAQPage schema for rich results
      {
        '@type': 'FAQPage',
        '@id': 'https://loopgate.gg/#faq',
        mainEntity: [
          {
            '@type': 'Question',
...
export const pageSEO = {
  ...
  rankings: {
    ...
    canonical: 'https://loopgate.gg/rankings',
  ...
  index: {
    ...
    canonical: 'https://loopgate.gg/index',
  ...
  events: {
    ...
    canonical: 'https://loopgate.gg/events',
  ...
  leagues: {
    ...
    canonical: 'https://loopgate.gg/leagues',
  ...
  enterprise: {
    ...
    canonical: 'https://loopgate.gg/enterprise',
  ...
  login: {
    ...
    canonical: 'https://loopgate.gg/start',
  ...
  rules: {
    ...
    canonical: 'https://loopgate.gg/rules',
  ...
  support: {
    ...
    canonical: 'https://loopgate.gg/support',
  ...
  hub: {
    ...
    canonical: 'https://loopgate.gg/hub',
    noindex: true,
  },
  arena: {
    ...
    canonical: 'https://loopgate.gg/arena',
  ...
  download: {
    ...
    canonical: 'https://loopgate.gg/download',
  ...
  about: {
    ...
    canonical: 'https://loopgate.gg/about',
  ...
  howItWorks: {
    ...
    canonical: 'https://loopgate.gg/how-it-works',
  ...
  faq: {
    ...
    canonical: 'https://loopgate.gg/faq',
  ...
  privacy: {
    ...
    canonical: 'https://loopgate.gg/privacy',
  },
  editorium: {
    ...
    canonical: 'https://loopgate.gg/editorium',
  ...
  gqt: {
    ...
    canonical: 'https://loopgate.gg/gqt',
  ...
  crews: {
    ...
    canonical: 'https://loopgate.gg/crews',
  ...
  judges: {
    ...
    canonical: 'https://loopgate.gg/judges',
